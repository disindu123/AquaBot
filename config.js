...
module.exports = {
    ...
    CHANNEL: 'https://t.me/',
    SESSION: process.env.AQUA_SESSION === undefined ? 'DisinduDamsandu123456' : process.env.AQUA_SESSION,
    ...
    CHATBOT: process.env.CHATBOT === undefined ? 'true' : process.env.CHATBOT,
